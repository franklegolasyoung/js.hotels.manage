...
<div class="ui middle aligned center aligned grid">
  <div class="column">
    <h1 style="color:white;">Frank's 宾馆后台数据系统</h1>
          ...
          <div class="inline fields">
            ...
            <div class="field" align="center">
              <div class="ui radio checkbox">
                ...
                <label style="color:white;"><i class="user icon"></i>系统管理员</label>
              </div>
            </div>
            <div class="field">
              <div class="ui radio checkbox">
                <input type="radio" name="admin" value="1">
                <label style="color:white;"><i class="users icon"></i>宾馆管理员</label>
              </div>
            </div>
          </div>
          <div class="field">
