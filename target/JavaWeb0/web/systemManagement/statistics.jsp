    ...
    <div class="ui fluid container">
        ...
        <div class="ui column grid">
            ...
            <div class="nine wide column">
                ...
                <%--</script>--%>
                <div id="weekTypeNum" style="width:100%;height:300%;"></div>
            ...
            <div class="seven wide column">
                <div id="waiter" style="width:100%;height:100%;"></div>
                <script>
            ...
            <%--//营收数据统计--%>
            <div class="nine wide column">
                <div id="income" style="width: 100%;height:500%;"></div>
                <script>
            ...
            <%--//酒店房间数据统计--%>
            <div class="seven wide column">
                <div id="rooms" style="width:100%;height:100%;"></div>
                <script type="text/javascript">
