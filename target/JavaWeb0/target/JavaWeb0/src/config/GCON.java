...
//    public static final String URL = "jdbc:mysql://localhost:3306/new?autoReconnect=true&useSSL=false&useUnicode=true&charaterEncoding=UTF";
    public static final String URL="jdbc:mysql://localhost:3306/hotel?useUnicode=true&characterEncoding=UTF-8&useSSL=false&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
    //登录时默认使用system用户验证登录名与密码是否正确
    public static  String USERNAME = "root";

    public static  String PASSWORD = "104532sql";

    public static final String SYSTEMUSERNAME = "root";

    public static final String SYSTEMPASSWORD = "104532sql";

    public static final String HOTELUSERNAME = "root";

    public static final String HOTELPASSWORD = "104532sql";
